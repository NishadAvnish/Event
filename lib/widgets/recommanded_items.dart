                          ...
                          itemBuilder: (context, index) {
                            return  GestureDetector(
                              onTap: () => Navigator.of(context)
                                  .pushNamed(EventDetail.route,arguments: dashbo.recommandedItems[index].id),
                                                      child: Card(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            image: DecorationImage(
                                                fit: BoxFit.cover,
                                                image: NetworkImage(dashbo.recommandedItems[index].eventImage)),
                                          ),
                                        ),
                                      ),
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            Text(dashbo.recommandedItems[index].eventName,
