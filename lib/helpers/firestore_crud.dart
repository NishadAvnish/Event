...
class CrudOperation {
  static Future<void> add() async {
    try {
      await Firestore.instance.collection("Post").document().setData({
        "EventImages": [
  ...
  static Future<void> fetch() async {
    await Firestore.instance
        .collection("Post/Category/InformationTech")
        .getDocuments()
        .then((snapshot) {
      if (snapshot != null) {
